...
import 'package:{{project_name}}/app/core/utils/screen_utils.dart';
...
class OtpViewState extends State<OtpView> with SingleTickerProviderStateMixin {
  ...
  Widget _buildFieldInput(BuildContext context, int i) {
    ...
    if (widget.otpPinFieldDecoration ==
        PinFieldDecoration.underlinedPinBoxDecoration) {
      boxDecoration = BoxDecoration(
        border: Border(
          bottom: BorderSide(
        ...
        PinFieldDecoration.defaultPinBoxDecoration) {
      boxDecoration = BoxDecoration(
          border: Border.all(
            color: fieldBorderColor,
            width: 2.0,
        ...
        PinFieldDecoration.roundedPinBoxDecoration) {
      boxDecoration = BoxDecoration(
        border: Border.all(
          color: fieldBorderColor,
    ...
    return InkWell(
      ...
      child: Container(
          width: screenWidth(percentage: 16),
